...
export default function NewExpenseDialog({ onAdd, trigger }: Props) {
      ...
      <DialogContent className="bg-bg-surface-1 border-b-subtle max-w-sm">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            <Label className="font-ui text-[12px] text-t-secondary">Label</Label>
            <Input
              value={label}
              onChange={(e) => setLabel(e.target.value)}
              placeholder="Ex: Achat de ballons"
